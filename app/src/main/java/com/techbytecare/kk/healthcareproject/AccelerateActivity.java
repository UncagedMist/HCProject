...
public class AccelerateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        patData = database.getReference("AcceleroMeterData");

        btnData = findViewById(R.id.btnData);

        recyclerView = findViewById(R.id.recyclerAccelerate);
        ...
        btnData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(AccelerateActivity.this, "Loading....", Toast.LENGTH_SHORT).show();
                loadData();
            }
        });
    }
    ...
    private void loadData() {
        ...
        Query search = patData.orderByChild("field").equalTo(Common.currentPatient.getPhone());
